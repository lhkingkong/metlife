...
$(function () {
        $("#toggle1").click(function () {
			$("#dv-ml-form-field-toggle1").toggle();
		});
    });
$(function () {
        $("#toggle2").click(function () {
			$("#dv-ml-form-field-toggle2").toggle();
		});
    });
$(document).ready(function () {
        $("#toggle3").select(function () {
            var sel = $('#toggle3');
			alert(sel.val());
            if (sel.val() === '2') {
                $("#dv-ml-form-field-toggle3").show();
            }
            else {
                $("#dv-ml-form-field-toggle3").hide();
			}
        });
    });
$(function () {
        $("#other").click(function () {
            if ($(this).is(":checked")) {
                $("#dv-ml-form-field-toggle").show();
            } else {
                $("#dv-ml-form-field-toggle").hide();
            }
        });
    });
